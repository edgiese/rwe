...
// prototype class to process credit card transactions through authorize.net
// for more detail see:  http://www.merchant-account-services.org/article/authorize-net-php-integration/1
class ec_authnet
{
    private $login    = "";
    private $transkey = "";
